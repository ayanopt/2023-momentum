...
```{r}
data5_15 = read.csv("../csvs/train5_15.csv")
```

# Data exploration for 5_15
...
data5_15$norm_volume = (data5_15$Volume - mean(data5_15$Volume))/sd(data5_15$Volume)
ind = sample(1:nrow(data5_15),0.75*nrow(data5_15))
train = data5_15[ind,]
test = data5_15[-ind,]
```
