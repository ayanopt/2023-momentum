...
price reaches take profit or stop loss first. It assumes a 100 share
position size.
...
Encodes 0 if `pl_value` \< 0

### Normalized volume

Standard normalization $norm\_vol = \frac{mean(Vol) - Vol}{sd(Vol)}$
...
`pl_value` is calculated with 100 shares of SPY. In trading, using 2%
of your portfolio in a trade is recommended, hence, The initial capital
is set at $\frac{1}{0.02} * (100 * Price)$.
...
markets where relationships between indicators and outcomes
change dynamically.
