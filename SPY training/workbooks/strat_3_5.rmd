...
```{r}
data3_5 = read.csv("../csvs/train3_5.csv")
```

# Data exploration for 3_5
...
data3_5$norm_volume = (data3_5$Volume - mean(data3_5$Volume))/sd(data3_5$Volume)
ind = sample(1:nrow(data3_5),0.75*nrow(data3_5))
train = data3_5[ind,]
test = data3_5[-ind,]
```
