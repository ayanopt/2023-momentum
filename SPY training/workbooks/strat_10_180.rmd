...
```{r}
data10_180 = read.csv("../csvs/train10_180.csv")
```

# Data exploration for 10_180
...
data10_180$norm_volume = (data10_180$Volume - mean(data10_180$Volume))/sd(data10_180$Volume)
ind = sample(1:nrow(data10_180),0.75*nrow(data10_180))
train = data10_180[ind,]
test = data10_180[-ind,]
```
