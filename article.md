...
The ensemble prediction strategy applied the default threshold of 0.5 across all three models, as the consensus of the models with their optimized threshold was too infrequent to gain valuable insights. 
